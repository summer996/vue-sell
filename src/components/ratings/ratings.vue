<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingSelect @content-toggle="contentToggle(onlyContent)" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="this.ratings"></ratingSelect>
      <div class="rating-wrapper">
        <ul>
          <li v-for="rating in ratings" :key="rating.username" class="rating-item">
            <div class="avatar">
